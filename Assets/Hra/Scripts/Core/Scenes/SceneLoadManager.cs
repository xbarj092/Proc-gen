public class SceneLoadManager : MonoSingleton<SceneLoadManager>
{
    ...
    public void GoMenuToGame()
    {
        ...
        SceneLoader.LoadScene(SceneLoader.Scenes.GameScene, false, toUnload: SceneLoader.Scenes.MenuScene);
    }
    ...
    public void GoGameToMenu()
    {
        ...
        SceneLoader.LoadScene(SceneLoader.Scenes.MenuScene, false, toUnload: SceneLoader.Scenes.GameScene);
    }
